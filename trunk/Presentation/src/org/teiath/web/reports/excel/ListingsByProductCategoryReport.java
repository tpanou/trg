...
public class ListingsByProductCategoryReport {

	public HSSFWorkbook exportList(ListingsExcelService listingsExcelService, ProductCategory productCategory) {
		...
		excelToolkit
				.createCell(ExcelToolkit.GENERIC, wb, row, font, 1, "Ημερομηνία Αγγελίας", HSSFCellStyle.ALIGN_CENTER,
						HSSFCellStyle.VERTICAL_CENTER, false, true, HSSFColor.GREY_25_PERCENT.index);
		excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 2, "Κωδικός", HSSFCellStyle.ALIGN_CENTER,
		...
		excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 6, "Κατάσταση", HSSFCellStyle.ALIGN_CENTER,
				HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.GREY_25_PERCENT.index);
		excelToolkit
				.createCell(ExcelToolkit.GENERIC, wb, row, font, 7, "Ιδιοκτήτης Αγγελίας", HSSFCellStyle.ALIGN_CENTER,
						HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.GREY_25_PERCENT.index);
		...
		try {
			Collection<Listing> listings = listingsExcelService.getListingsByProductCategory(productCategory);
			...
			for (Listing listing : listings) {
				...
				excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 3, listing.getPrice().toString(),
						HSSFCellStyle.ALIGN_LEFT, HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.WHITE.index);
				excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 4, listing.getProductName(),
						HSSFCellStyle.ALIGN_LEFT, HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.WHITE.index);
				excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 5, listing.getTransactionType().getName(),
						HSSFCellStyle.ALIGN_CENTER, HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.WHITE.index);
				excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 6,
						...
						HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.WHITE.index);
				excelToolkit.createCell(ExcelToolkit.GENERIC, wb, row, font, 7, listing.getUser().getFullName(),
						HSSFCellStyle.ALIGN_LEFT, HSSFCellStyle.VERTICAL_CENTER, true, true, HSSFColor.WHITE.index);
			}
