...
@Service("createProductNotificationCriteriaService")
@Transactional
public class CreateProductNotificationCriteriaServiceImpl
		implements CreateProductNotificationCriteriaService {
