...
public class ListingsByTransactionTypeReport {

	public HSSFWorkbook exportList(ListingsExcelService listingsExcelService, TransactionType transactionType) {
		...
		try {
			Collection<Listing> listings = listingsExcelService.getListingsByTransactionType(transactionType);
